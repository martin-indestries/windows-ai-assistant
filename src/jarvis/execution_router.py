...
class ExecutionRouter:
    ...
    def __init__(self) -> None:
        ...
        self.direct_keywords = {
            "write", "code", "program", "script", "run", "execute", "create",
            "generate", "build", "make", "implement", "develop", "search"
        }
        
        # Planning mode keywords (complex, multi-step requests)
        self.planning_keywords = {
            "with", "and", "then", "also", "including", "plus", "multi",
            "step", "phase", "stage", "pipeline", "workflow", "system",
            "framework", "application", "platform", "architecture", "setup",
            "configure", "deploy", "integrate", "connect", "chain"
        }
        
        # Complexity indicators (suggest planning mode)
        self.complexity_indicators = {
            "error handling", "logging", "testing", "validation", "authentication",
            "database", "api", "web", "server", "client", "frontend", "backend",
            "scraper", "parser", "processor", "manager", "controller", "service"
        }
